      ...
      <Form :model="newRow" ref="newRow">
        ...
        >
          ...
          >
            ...
            />
            <HolderOutlined class="table-setting-btn table-sort-handle" />
          </Space>
        </vue-drag>
...
import vueDrag from "../../entery/vuedrag.vue";
